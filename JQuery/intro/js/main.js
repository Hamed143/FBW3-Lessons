// $("h1") is the same of document.querySelctorAll("h1");
...
"background":"rgba(100,99,55",
"fontSize":"2em",
"color":"#fff"
});
console.log($("h1").css("backgroundColor")); // rgba(255,165,0)
...
// Selct the first div with class highlight and change its font color to orange
$("div.highlight:first").css("color","orange");

// change the text of the h1 from 'jquery is nice' to 'jequery is awsome'
...
$("img").attr("scr","https://picsum.photo/id/392/800/400");
$("img").css("width","200px");
$("img:eq(1)").attr("scr","https://picsum.photo/id/391/800/400");

$("img:eq(0)").attr("tittle","Brdige photo");